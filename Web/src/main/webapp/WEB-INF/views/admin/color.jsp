	...
	<div class="col-md-7 col-xs-12">
		<div class="row">
			<div class="col-md-12 col-xs-12">
				...
				<div class="form-group">
						<label for="name" style="color:red;text-align:left;" class="col-sm-10 col-sm-offset-2 control-label"><form:errors path="color"/></label>
					</div>
					<div class="form-group">
    					<label for="color" class="col-sm-2 control-label">Name</label>
    					<div class="col-sm-10">
